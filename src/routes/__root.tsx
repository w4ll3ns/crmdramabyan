...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Dra. Mabyan CRM is a mobile-first PWA for aesthetic clinics." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Dra. Mabyan — CRM" },
      { name: "description", content: "Dra. Mabyan CRM is a mobile-first PWA for aesthetic clinics." },
      { name: "twitter:description", content: "Dra. Mabyan CRM is a mobile-first PWA for aesthetic clinics." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/fdb8e64c-91e1-4c93-a7ac-965392916614/id-preview-23553edc--ad354cb1-87ea-4a9c-8eed-f91574a39190.lovable.app-1782661992564.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/fdb8e64c-91e1-4c93-a7ac-965392916614/id-preview-23553edc--ad354cb1-87ea-4a9c-8eed-f91574a39190.lovable.app-1782661992564.png" },
